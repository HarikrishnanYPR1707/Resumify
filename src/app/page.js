...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-center">
      <div className="mx-32 flex flex-col items-center justify-center text-center">
          ...
          <div className="grid grid-cols-2 gap-4 p-5">
            ...
            <div className="flex items-start justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm">
                  Download your resume in PDF and other common formats with just
                  a click.
                </p>
              </div>
            </div>
        ...
        <div className="mt-5 flex w-[1200px] items-center justify-center gap-8 p-10 text-left">
          <Image
            ...
            height="100"
            src="/img1.svg"
            alt="ResumeCat Resume Example"
          />
          <div className="flex flex-col items-start justify-center">
            <h2 className="text-base text-Green">RESUME MAKER</h2>
            <h1 className="text-4xl font-black">
              Building a Strong Resume is the First Step Toward a{" "}
            ...
            <p className="text-base text-DarkGray">
              ...
              experience your engaging personality, strong dedication to work,
              and seamless team compatibility, your resume serves as your
              representative and must effectively convey these qualities.
              <br />
              That's why it's crucial for your resume to effectively convey your
              identity, highlight your unique skills and contributions, and
              compel them to reach out and invite you for an interview without
              hesitation.
              <br />
        ...
        <div className="mt-5 flex w-[1200px] items-center justify-center gap-8 p-10 text-left">
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="text-base text-DarkGray">
              ...
              features like optimized white space, well-structured columns, and
              clear, reader-friendly headings, our tools guarantee a precise
              representation of your skills and abilities in each section. What
              sets us apart is the speed, ease, and readiness it provides for
              your journey into a new career.
            </p>
          </div>
          <Image
            className="w-[520px]"
          ...
          <div className="mt-8">
            <dl className="divide-y divide-gray-200">
              <div className="pb-8 pt-6 md:grid md:grid-cols-12 md:gap-8">
                ...
                <dd className="mt-2 md:col-span-7 md:mt-0">
                  <p className="text-base text-gray-500">
                    Absolutely! Resumify has lots of different tools you can use
                    for free.
                  </p>
                </dd>
              </div>
              <div className="pb-8 pt-6 md:grid md:grid-cols-12 md:gap-8">
                ...
                <dd className="mt-2 md:col-span-7 md:mt-0">
                  <p className="text-base text-gray-500">
                    We have professionally built templates that are designed to
      ...
      {/* FOOTER --> SECTION */}
      <footer className="grid h-[500px] w-full place-content-center bg-black text-white">
        <div className="h-[400px] w-[1200px] border">
